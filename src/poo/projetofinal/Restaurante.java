...
public class Restaurante {
	...
	static Item frango = new Item("Filé de Frango", 27.97);
	static Item frango2 = new Item("Frango à Parmegiana", 28.00);
	static Item feijoada = new Item("Feijoada", 25.00);
	static Item lasanha = new Item("Lasanha", 30.00);
	static Item bisteca = new Item("Bisteca Suína", 27.50);
	static Item cavalo = new Item("Bife à Cavalo", 35.55);
	...
	public static void adicionarItem() {
		...
		System.out.println("Selecione o prato que você deseja: ");
		...
		System.out.println("5. Filé de Frango - R$27,97");
		System.out.println("6. Frango à Parmegiana - R$28,00");
		System.out.println("7. Feijoada - R$ 25,00");
		System.out.println("8. Lasanha -  R$ 30,00");
		System.out.println("9. Bisteca Suína - R$ 27,50");
		System.out.println("10. Bife à Cavalo - R$ 35,55");
